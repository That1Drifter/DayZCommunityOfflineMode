...
class LootDebug extends Module
{
    ...
    protected string PROTO_PATH = "$CurrentDir:Missions\\DayZCommunityOfflineMode.Namalsk\\mapgroupproto.xml";
    protected string TYPES_PATH = "$CurrentDir:Missions\\DayZCommunityOfflineMode.Namalsk\\db\\types.xml";
