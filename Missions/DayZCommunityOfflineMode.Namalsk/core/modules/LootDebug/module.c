...
#include "$CurrentDir:missions\\DayZCommunityOfflineMode.Namalsk\\core\\modules\\LootDebug\\gui\\LootDebugMenu.c"
#include "$CurrentDir:missions\\DayZCommunityOfflineMode.Namalsk\\core\\modules\\LootDebug\\LootDebug.c"
#endif
