...
class LootDebug extends Module
{
    ...
    protected string PROTO_PATH = "$CurrentDir:Missions\\DayZCommunityOfflineMode.Sakhal\\mapgroupproto.xml";
    protected string TYPES_PATH = "$CurrentDir:Missions\\DayZCommunityOfflineMode.Sakhal\\db\\types.xml";
