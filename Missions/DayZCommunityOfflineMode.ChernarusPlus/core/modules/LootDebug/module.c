...
#include "$CurrentDir:missions\\DayZCommunityOfflineMode.ChernarusPlus\\core\\modules\\LootDebug\\gui\\LootDebugMenu.c"
#include "$CurrentDir:missions\\DayZCommunityOfflineMode.ChernarusPlus\\core\\modules\\LootDebug\\LootDebug.c"
#endif
