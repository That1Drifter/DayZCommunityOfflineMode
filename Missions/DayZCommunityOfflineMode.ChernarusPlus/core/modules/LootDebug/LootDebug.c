...
class LootDebug extends Module
{
    ...
    protected string PROTO_PATH = "$CurrentDir:Missions\\DayZCommunityOfflineMode.ChernarusPlus\\mapGroupProto.xml";
    protected string TYPES_PATH = "$CurrentDir:Missions\\DayZCommunityOfflineMode.ChernarusPlus\\db\\types.xml";
