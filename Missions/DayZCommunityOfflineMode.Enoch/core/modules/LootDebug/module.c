...
#include "$CurrentDir:missions\\DayZCommunityOfflineMode.Enoch\\core\\modules\\LootDebug\\gui\\LootDebugMenu.c"
#include "$CurrentDir:missions\\DayZCommunityOfflineMode.Enoch\\core\\modules\\LootDebug\\LootDebug.c"
#endif
